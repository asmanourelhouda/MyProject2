...
<html class="error-page">
    <head>
        ...
        <link rel="stylesheet" media="screen" href="css/my_style.css">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                <div class="col-lg-12">
                    <div class="centering text-center bg-white_tiles">
                        ...
                        <div class="text-center">
                            <h3><small>Retour au </small></h3>
                        </div>
                        <hr>
                        <ul class="pager">
                            <li><a href="<?=WEBRoot?>">&larr; Dashbord </a></li> 
                        </ul>
                    </div>
                </div>
            </div>
